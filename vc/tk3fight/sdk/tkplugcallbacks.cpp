...
////////////////////////////////////////////////////////////////
//
// File:					tkplugcallbacks.cpp
// Includes:			tkplugdefines.h
//								tkpluglocalfns.h
// Description:		Implements all the callback functions.  You really
//								should not modify this file, as doing so
//								may mess things up a lot.
//
////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////
//
// Function: CBFighterAddStatusEffect
//
// Callback no: 131-Sub CBFighterAddStatusEffect(ByVal partyIdx As Long, ByVal fightIdx As Long, ByVal statusFile As String)
//
// Parameters: nPartyIdx - party of fighter to apply
//						 nFighterIdx - fighter to apply
//						 strStatusFile - Filename of status effect to use (no path)
//
// Action: Apply a status effect to a fighter
//
// Returns: void
//
///////////////////////////////////////////////////////
void CBFighterAddStatusEffect( int nPartyIdx, int nFighterIdx, std::string strStatusFile )
{
	//call into vb callback 131

	//declare the function pointer
	typedef void (__stdcall *FUNCPTR)( int p, int f, BSTR sf );
	FUNCPTR vbFunc;

	//point the function pointer at the passed-in address...
	vbFunc = (FUNCPTR)g_lCallbacks[131];

	BSTR bsFile = String2BSTR(strStatusFile);

	//call the function thru the function pointer
	vbFunc( nPartyIdx, nFighterIdx, bsFile );
...
///////////////////////////////////////////////////////
//
// Function: CBFighterRemoveStatusEffect
//
// Callback no: 132-Sub CBFighterRemoveStatusEffect(ByVal partyIdx As Long, ByVal fightIdx As Long, ByVal statusFile As String)
//
// Parameters: nPartyIdx - party of fighter
//						 nFighterIdx - fighter
//						 strStatusFile - Filename of status effect to use (no path)
//
// Action: Remove a status effect from a fighter
//
// Returns: void
//
///////////////////////////////////////////////////////
void CBFighterRemoveStatusEffect( int nPartyIdx, int nFighterIdx, std::string strStatusFile )
{
	//call into vb callback 132
	...
	//point the function pointer at the passed-in address...
	vbFunc = (FUNCPTR)g_lCallbacks[132];
