...
Begin VB.Form testprefs 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Label Label6 
         BackStyle       =   0  'Transparent
         Caption         =   "These preferences will be used when test running a program"
         ForeColor       =   &H00808080&
         Height          =   375
         Left            =   120
         TabIndex        =   8
...
Private Sub btnOK_Click(): On Error Resume Next
 Command1_Click
End Sub

Private Sub CloseX_Click(): On Error Resume Next
 Unload Me
End Sub
...
Private Sub Command14_Click(): On Error Resume Next
    ChDir (currentDir)
    Dim dlg As FileDialogInfo
...
Private Sub Form_Load(): On Error Resume Next
    ...
    Text4.Text = rpgcodeList(activeRPGCodeIndex).Iboard
    If rpgcodeList(activeRPGCodeIndex).IfontSize > 8 Then Text5.Text = CStr(rpgcodeList(activeRPGCodeIndex).IfontSize)
...
Private Sub lblOK_Click(): On Error Resume Next
 Command1_Click
End Sub
...
Private Sub Text5_Change(): On Error Resume Next
