...
Sub infofill()
    ...
    For t = 0 To UBound(itemList(activeItemIndex).theData.customGfxNames)
        If itemList(activeItemIndex).theData.customGfxNames(t) <> "" Then
            spriteList.AddItem (itemList(activeItemIndex).theData.customGfxNames(t))
        End If
    Next t
...
Private Sub Command14_Click()
    ...
    If idx < UBound(itemList(activeItemIndex).theData.gfx) Then
        itemList(activeItemIndex).theData.gfx(idx) = antiPath$
    Else
        dx = itemGetCustomHandleIdx(itemList(activeItemIndex).theData, idx - UBound(itemList(activeItemIndex).theData.gfx))
        itemList(activeItemIndex).theData.customGfx(dx) = antiPath$
    End If
End Sub
...
Private Sub Command8_Click()
    ...
    anmFile$ = ""
    If idx < UBound(itemList(activeItemIndex).theData.gfx) Then
        anmFile$ = itemList(activeItemIndex).theData.gfx(idx)
    Else
        dx = itemGetCustomHandleIdx(itemList(activeItemIndex).theData, idx - UBound(itemList(activeItemIndex).theData.gfx))
        anmFile$ = itemList(activeItemIndex).theData.customGfx(dx)
    End If
...
Private Sub spriteList_Click()
    ...
    If idx < UBound(itemList(activeItemIndex).theData.gfx) Then
        Text1.text = itemList(activeItemIndex).theData.gfx(idx)
    Else
        dx = itemGetCustomHandleIdx(itemList(activeItemIndex).theData, idx - UBound(itemList(activeItemIndex).theData.gfx))
        Text1.text = itemList(activeItemIndex).theData.customGfx(dx)
    End If
End Sub
...
Private Sub Text1_Change()
    ...
    If idx < UBound(itemList(activeItemIndex).theData.gfx) Then
        itemList(activeItemIndex).theData.gfx(idx) = Text1.text
    Else
        dx = itemGetCustomHandleIdx(itemList(activeItemIndex).theData, idx - UBound(itemList(activeItemIndex).theData.gfx))
        itemList(activeItemIndex).theData.customGfx(dx) = Text1.text
    End If
End Sub
