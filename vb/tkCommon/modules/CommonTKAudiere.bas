...
Declare Sub TKAudiereInit Lib "actkrt3.dll" ()

Declare Sub TKAudiereKill Lib "actkrt3.dll" ()

Declare Function TKAudierePlay Lib "actkrt3.dll" (ByVal handle As Long, ByVal filename As String, ByVal streamYN As Long, ByVal autoRepeatYN As Long) As Long

Declare Function TKAudiereIsPlaying Lib "actkrt3.dll" (ByVal handle As Long) As Long

Declare Sub TKAudiereStop Lib "actkrt3.dll" (ByVal handle As Long)

Declare Sub TKAudiereRestart Lib "actkrt3.dll" (ByVal handle As Long)

Declare Sub TKAudiereDestroyHandle Lib "actkrt3.dll" (ByVal handle As Long)

Declare Function TKAudiereCreateHandle Lib "actkrt3.dll" () As Long

Declare Function TKAudiereGetPosition Lib "actkrt3.dll" (ByVal handle As Long) As Long

Declare Sub TKAudiereSetPosition Lib "actkrt3.dll" (ByVal handle As Long, ByVal pos As Long)
