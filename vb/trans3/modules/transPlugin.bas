...
'=========================================================================
Public Function queryPlugins(ByVal mName As String, ByVal Text As String, ByRef retval As RPGCODE_RETURN, ByRef prg As RPGCodeProgram) As Boolean
        ...
        If (LenB(mainMem.plugins(t))) Then
            ...
            If (doesRPGCode) Then
                ...
                If (canHandle) Then
                    ...
                    ' Let plugins see recent stack changes
                    errorKeep = prg
